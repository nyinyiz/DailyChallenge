...
import com.nyinyi.dailychallenge.feature.play.multiselect.components.MultipleSelectResultScreen
    ...
    AppScreenScaffold(
        ...
        Column(
            ...
            when (val state = uiState) {
                is MultipleSelectUiState.Loading -> LoadingPlayState()
...
private fun QuizContent(
    session: com.nyinyi.dailychallenge.feature.play.multiselect.MultipleSelectSession,
        ...
        session.currentQuestion?.let { question ->
            ...
            LazyColumn(
                ...
                items(
                    ...
                    OptionItem(
                        option = option,
                        isSelected = session.selectedOptions.contains(option),
                        onClick = {
            ...
            Box(
                ...
                Button(
                    ...
                    enabled = session.selectedOptions.isNotEmpty(),
