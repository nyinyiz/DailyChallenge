package com.nyinyi.dailychallenge.feature.play.home.components
...
sealed class PlayMode(
    ...
    data object TrueOrFalse : PlayMode(
        "True or False",
    ...
    data object MultipleChoice : PlayMode(
        "Multiple Choice",
    ...
    data object MultipleSelect : PlayMode(
        "Multiple Select",
    ...
    data object MatchingGame : PlayMode(
        "Matching Game",
...
@Composable
fun PlayModeSection(onPlayModeSelected: (PlayMode) -> Unit) {
    val playModes =
        listOf(
    ...
    Column(
        ...
        Column(
            ...
            playModes.chunked(2).forEach { rowItems ->
                Row(
                    modifier = Modifier.fillMaxWidth(),
                    horizontalArrangement = Arrangement.spacedBy(8.dp),
                ) {
                    rowItems.forEach { playMode ->
                        GameModeCard(
                            playMode = playMode,
                            onSelected = { onPlayModeSelected(playMode) },
        ...
        Box(
            modifier =
                Modifier
                    .fillMaxSize()
                    .background(
                        brush = Brush.linearGradient(playMode.backgroundColor),
                    ),
        ) {
