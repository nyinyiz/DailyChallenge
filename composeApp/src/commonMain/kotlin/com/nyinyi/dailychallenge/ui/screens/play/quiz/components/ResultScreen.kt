...
import com.nyinyi.dailychallenge.ui.screens.play.components.CircularQuizResultSummary
    ...
    Box(modifier = Modifier.fillMaxSize()) {
        Column(
            ...
            CircularQuizResultSummary(
                ...
                scoreLabel = "${result.correctAnswers}/${result.totalQuestions}",
            )
...
private fun ReviewQuestionCard(question: QuizCard) {
    QuizExpandableReviewCard(
        ...
        answerLabel = "Correct Answer: ${if (question.correctAnswer) "True" else "False"}",
